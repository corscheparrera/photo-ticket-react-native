...
const Color = props => <Text style={{ color: "red" }}>{props.children}</Text>;
    ...
    368: {
      ...
      conditions: (
        <Text>
          L’infraction est commise lorsque ces trois conditions sont remplies:
          {"\n\n"}
          <Bold>1- </Bold>Vous êtes conducteur d’un véhicule routier
          {"\n\n"}
          <Bold> OU </Bold>
          {"\n\n"}
          Vous conduisez une bicyclette
          {"\n\n"}
          <Bold>2- </Bold>Vous faites face à un panneau d’arrêt
          {"\n\n"}
          <Bold>3- </Bold>Vous n’immobilisez pas votre véhicule<Bold> OU </Bold>Vous
          omettez de céder le passage à tout véhicule déjà engagé dans
          l’intersection, sans danger.
        </Text>
      ),
      défense: (
        <Text>
          L’infraction n'est commise lorsque ces trois conditions sont remplies:
          {"\n\n"}
          <Bold>1- </Bold>Vous êtes conducteur d’un véhicule routier
          {"\n\n"}
          <Bold> OU </Bold>
    ...
    368: {
      ...
      conditions: (
        <Text>
          L’infraction est commise lorsque ces trois conditions sont remplies:
          {"\n\n"}
          <Bold>1- </Bold>Vous êtes conducteur d’un véhicule routier<Bold>
            {" "}
            OU{" "}
          </Bold>Vous conduisez une bicyclette
          {"\n\n"}
          <Bold>2- </Bold>Vous faites face à un panneau d’arrêt
          {"\n\n"}
          <Bold>3- </Bold>Vous n’immobilisez pas votre véhicule<Bold> OU </Bold>Vous
