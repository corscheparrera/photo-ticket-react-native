...
const infractions = {
  328: {
    ...
    conditions:
      'L’infraction est commise lorsque ces trois conditions sont remplies:\n1- Vous êtes conducteur d’un véhicule routier\n2- Vous circulez dans une zone où la vitesse est limitée\n3- Vous circulez à une vitesse supérieure à cette limite.',
    point:
  ...
  368: {
    ...
    conditions:
      'L’infraction est commise lorsque ces trois conditions sont remplies:\n1- Vous êtes le conducteur d’un véhicule routier\nOU\nVous conduisez une bicyclette\n2- Vous faites face à un panneau d’arrêt\n3- Vous n’immobilisez pas votre véhicule\nOU\nVous omettez de céder le passage à tout véhicule déjà engagé dans l’intersection, sans danger.',
    point:
...
export const parseData = res => {
  ...
  const infraction = infractions[number] // { type: 'Circulation', Règlement: 'C-24.2', ...
